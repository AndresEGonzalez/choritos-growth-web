...
```{r}
#| echo: false
#| label: fig-grupo-lab-working
#| fig-cap: "Equipo de laboratorio trabajando en conjunto para poder cumplir con los primeros 4.000 <i>P. purpuratus</i> marcados."
#| fig-align: center
#| out-width: "80%"

knitr::include_graphics("photos/Marcaje_Choritos_2.jpeg")
```
...
![Adhesión de etiquetas (Bee-Tags)](photos/Marcaje_Choritos_3.jpeg){#fig-adhesion width=80%}

![Modelo de <i>P. purpuratus</i> con Bee-Tag adherido](photos/Choritos_marcados_2.jpeg){#fig-marcaje width=80%}
...
![Tratamiento "anuales" y clase de talla "grandes" de <i>P. purpuratus</i> marcados con Bee-Tags blancos](photos/Choritos_marcados_1.jpeg){#fig-marcaje width=80%}
...
```{r}
#| echo: false
#| label: fig-trasplant-domo-detail
#| fig-cap: "Sistema de trasplante solo con el domo de protecciónen El Temblador."
#| fig-align: center
#| out-width: "80%"

knitr::include_graphics("photos/Trasplante_1_malla.jpeg")
```

```{r}
#| echo: false
#| label: fig-trasplant-domo-detail-in-action
#| fig-cap: "Sistema domo de protecciónen en acción. Sol de mar (<i>Heliaster helianthus</i>) tratando de alcanzar los choritos marcados."
#| fig-align: center
#| out-width: "80%"

knitr::include_graphics("photos/Trasplantes_terreno_viejo_2.jpeg")
```
...
![](photos/mosaico_trasplantes_terreno.jpeg)